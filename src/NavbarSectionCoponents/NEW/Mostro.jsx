  ...
  return (
    ...
    <div className="absolute inset-0 bg-black/60"></div>
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        {/* Header / Promo Banner */}
        <header className="w-screen -mx-6 bg-gradient-to-r from-red to-indigo-400 text-white text-center py-12 shadow-md mb-12 bg-opacity-90">
        ...
        <section className="relative min-h-screen grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-center px-8 py-20">
          ...
          <div className="flex flex-col items-center text-center">
            <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-8 drop-shadow-[0_0_20px_rgba(255,255,255,0.8)]">
              Mostro Sneakers
            </h1>
          ...
          <div className="flex items-center justify-center">
            <p className="max-w-md text-lg md:text-xl text-white leading-relaxed font-sans text-center md:text-left">
