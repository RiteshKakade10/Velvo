  ...
  return (
    <div className="pt-20 min-h-screen bg-neutral-950 text-white">
      ...
      <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden">   
        ...
        <div className="pt-70 relative z-20 max-w-4xl mx-auto text-center px-6">
          <motion.h1
      ...
      <section
        ...
        className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden mt-20"
      >
        <video
      ...
      <section className="relative py-20 px-6 max-w-7xl mx-auto space-y-24">
          <Palermo />
          <Mostro />
          <Contact />
      </section>
